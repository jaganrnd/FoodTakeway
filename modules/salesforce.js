...
let findOpportunityLineItem = (Oppty,orderCompleted) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        let q = "SELECT Opportunity.Tax__c,Opportunity.Exact_Amount__c,Id,product2.name,product2.PICURL__c,opportunityid,Opportunity.name,Opportunity.Amount,Opportunity.Order_Number__c,Opportunity.AccountId,Opportunity.TotalAmount__c,unitprice, TotalPrice, quantity from opportunitylineitem where opportunityid = '" + Oppty + "'";                 
