...
let findMainMenus = subaccountid => {
    return new Promise((resolve, reject) => {
        ...
        let q = "SELECT Account__c,Id,name,Product__r.name,Product__r.PICURL__c,product__r.description,Available__c FROM Menu__c WHERE Account__c = '" + subaccountid + "' AND  Product__r.Family = 'Parent' ";
