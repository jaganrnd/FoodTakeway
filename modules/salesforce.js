...
let findOpportunityLineItem = (Oppty,orderCompleted) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        let q = "SELECT Id,product2.name,product2.PICURL__c,opportunityid,Opportunity.name,Opportunity.Amount,Opportunity.AccountId,Opportunity.TotalAmount__c,unitprice, TotalPrice, quantity from opportunitylineitem where opportunityid = '" + Oppty + "'";                 
